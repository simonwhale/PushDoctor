...
namespace PDR.PatientBooking.Service.Tests.DoctorServices
{
    ...
    public class DoctorServiceTests
    {
        ...
        public void AddDoctor_AddsDoctorToContextWithGeneratedId()
        {
            ...
            var actualRecord = _context.Doctor.FirstOrDefault();
            Assert.AreEqual(expected.Id, actualRecord.Id);
            Assert.AreEqual(expected.FirstName, actualRecord.FirstName);
            Assert.AreEqual(expected.LastName, actualRecord.LastName);
            Assert.AreEqual(expected.Gender, actualRecord.Gender);
            Assert.AreEqual(expected.Email, actualRecord.Email);
        }
